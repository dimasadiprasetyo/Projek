...
<div class="card-header">
    <h1 style="color: #F08080;">
        <font size="5" face="Century Gothic"><i class="fas fa-file-alt" style='font-size:25px;'></i>&nbsp; LAPORAN PIUTANG-PEMILIK</font>
    </h1>
</div>
...
<div style="margin-top: 50px;">
    <div class="card" style="background-color: #040261">
        <div class="card-body">
            <div class="container">
